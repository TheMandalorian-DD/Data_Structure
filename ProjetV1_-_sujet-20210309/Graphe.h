...
typedef struct {
    int u, v;            /* Numeros des sommets extremites */
} Arete;
...
/* Retourne une liste chainee d'entier contenant les sommets-noeuds de la plus courte chaine 
   entre u et v dans le graphe G. Cette fonction est utilisee dans reorganiseReseau */
